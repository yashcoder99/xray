...
const aiData = {
    ...
    meaning: "Cancer",
    notes: "Quoted from source: Chest-CAD analysis identified suspicious regions of interest in the lungs, with one ROI encompassing early lung cancer in the left lung. A heatmap, which is an intermediate processing output of Chest-CAD and not shown to the end user, clearly focused on the known left infrahilar malignancy and post-obstructive left lower lung atelectasis. A heatmap is not part of the output of the FDA cleared device and provided here for illustrative purposes.
",
    reference: "https://doi.org/10.1016/j.rmcr.2022.101733"
};
