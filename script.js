var humanImagePath = "Lung2OG.png";
var aiImagePath = "Lung1.png";

var humanExhibit = "A";
var humanTitle = "Radiologist Analysis";
...
var aiExhibit = "B";
var aiTitle = "Chest-CAD (computer-assisted detection AI)";
var aiStatus = "flag";
...
metaDescription.setAttribute("content", "A comparison of a radiologist's and an AI system's read of the same chest X-ray.");
...
function createExhibit(imagePath, exhibitLetter, titleText, statusText, altText, pointsArray) {
    ...
    pending.textContent = "Fig. " + exhibitLetter + " — \"" + imagePath + "\" not found";
    ...
    while (i < pointsArray.length) {
        ...
        item.textContent = pointsArray[i];
...
var human = createExhibit(humanImagePath, humanExhibit, humanTitle, humanStatus, humanAlt, humanPoints);
exhibits.appendChild(human);
...
var ai = createExhibit(aiImagePath, aiExhibit, aiTitle, aiStatus, aiAlt, aiPoints);
exhibits.appendChild(ai);
...
var sourceText = document.createTextNode(" Sicular et al., \"Reevaluation of missed lung cancer with artificial intelligence,\" Respiratory Medicine Case Reports 39 (2022): 101733 — ");
